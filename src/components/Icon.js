  ...
  export const WhatsAppIcon = ({ className, ...rest }) => (
      ...
      >
        ...
        <g fill="none">
          ...
          <path
            fill="#fff"
            d="M128 56.73c-39.35 0-71.27 31.92-71.27 71.27 0 12.64 3.36 24.59 9.3 34.94l-9.77 35.53 36.58-9.58c9.95 5.35 21.27 8.42 33.15 8.42 39.35 0 71.27-31.92 71.27-71.27S167.35 56.73 128 56.73zm37.12 105.98c-1.07 3-6.24 5.59-8.68 5.94-2.22.31-4.88.44-7.91-.5a77.5 77.5 0 0 1-6.78-2.32c-11.98-4.78-19.63-12.57-27.6-22.93-2.25-3-4.9-6.55-6.52-10.2-1.74-3.91-1.88-7.4-.29-10.4.65-1.19 2.3-3 3.39-4.12.9-.91 1.78-1.82 2.65-2.73 1.24-1.31 2.06-2.28 3.35-3.82.9-1.06 1.55-1.35 2.82-1.09 1.33.27 3.13 1.22 5.08 1.99.71.28 1.38.56 1.97.83 1.82.77 3.42 1.45 5.09 2.42 1.2.7 2.59 1.7 3.7 2.38 1.19.74 1.71 1.53 2.68 2.48.86.85 2.26 1.86 3.5 2.58.96.53 1.76.53 2.72.18.87-.32 5.5-2.55 6.41-3 .91-.45 1.55-.74 2.47.09.92.82 4.34 5.12 5.06 6.07.71.95 1.07 1.55 1.37 2.5.3.95.08 2.02-.18 2.77-.48 1.44-2.45 4.69-3.85 7.54z"
          />
        </g>
      </svg>
    );
    ...
    export const InstagramIcon = ({ className, ...rest }) => (
      ...
      >
        ...
        <g fill="none">
          <rect width={256} height={256} fill="#fff" rx={60} />
          <rect width={256} height={256} fill="#E1306C" rx={60} />
          <path
            fill="#fff"
            d="M128 66.15a61.85 61.85 0 1 0 61.85 61.85A61.93 61.93 0 0 0 128 66.15zm0 101.46a39.61 39.61 0 1 1 39.61-39.61A39.65 39.65 0 0 1 128 167.61zM178.4 88.66a6.73 6.73 0 1 0-6.73-6.73 6.73 6.73 0 0 0 6.73 6.73z"
          />
        </g>
      </svg>
    );
    ...
    export const FacebookIcon = ({ className, ...rest }) => (
      ...
      >
          <path fill="none" d="M0 0h256v256H0z" />
          <rect width={256} height={256} fill="#3b5998" rx={60} />
          <path
              fill="#fff"
              d="M163.89 129.31h-23.5v86.11h-33.17v-86.11h-15.5v-27.23h15.5v-17.7c0-13.45 6.39-34.48 34.5-34.48h25.31v27.33h-18.42c-3.06 0-7.37 1.53-7.37 8.06v16.78h25.79l-3.63 27.23z"
          />
      </svg>
  );
